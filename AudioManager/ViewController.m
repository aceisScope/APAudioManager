...
- (void)viewDidLoad
{
    ...
    NSObject *playback = [[NSObject alloc] initWithURL:[NSURL URLWithString:@"http://statcon.247base.com/xmlserver/samples/24746000-24746999/A4316F812D071EA0E040010A0B06745F.mp3"] error:nil loadingType:APAudioLoadByStreaming  completedPlayback: ^(NSString *audioPath,id player ,NSError *error){
        self.mvPlayer = player;
     }];
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    button.frame = CGRectMake(10, 10, 100, 40);
    button.center = CGPointMake(CGRectGetMidX(self.view.frame), CGRectGetMidY(self.view.bounds));
